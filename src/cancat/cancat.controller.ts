import { Controller, Post,Req, UploadedFiles,ForbiddenException, Body, UseInterceptors } from '@nestjs/common';
...
export class CancatController {
    ...
    uploadFile(@UploadedFiles() files: Array<Express.Multer.File>, @Body() dto: FileDto, @Req() req: Request ) {
